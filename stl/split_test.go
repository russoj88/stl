...
func Test_splitTriangles(t *testing.T) {
	for _, tst := range []struct {
		...
		tst := tst
		t.Run(fmt.Sprintf("splitTriangles - %q", tst.in), func(t *testing.T) {
			t.Parallel()
			gotAdvance, gotToken, gotError := splitTriangles(tst.in, tst.eof)
...
func Test_splitTrianglesScanner(t *testing.T) {
